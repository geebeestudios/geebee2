...
const Banner = () => {
  return (
    <div className="w-full relative grid grid-cols-1 lg:grid-cols-2 px-10 lg:px-20 gap-20 lg:gap-0 lg:flex-row items-center justify-between pt-[150px] lg:pt-0 lg:h-[110dvh] bg-black text-white">
      <div className="px-10 flex flex-col gap-5">
        <h1 className="text-[40px] lg:text-[50px] font-montserrat font-bold">
      ...
      <div className="relative overflow-x-visible place-items-center h-fit">
        <img
          className="relative object-cover z-10 h-[550px] w-auto"
          src={bannerImg}
          alt=""
        />
        <img className="absolute right-[30%] -top-20" src={ellipse1} alt="" />
        <img
          className="absolute -right-[40px] lg:-right-20 top-[20%]"
          src={ellipse2}
          alt=""
        />
      </div>
      <div className="px-10 lg:hidden">
        ...
        <button className="mb-10 lg:mb-0 w-full sm:w-fit py-2 px-4 bg-primary text-[14px] text-white">
          Get Your Free Brand Strategy Audit
        </button>
      </div>
    </div>
