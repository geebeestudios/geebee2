    ...
    <div className="flex flex-col lg:flex-row gap-20 items-center py-20 px-10 lg:px-20 bg-gradient-to-br from-[#E9E4DC] via-[#E9E4DC] to-[#c7a9629b]">
      ...
      <div className="px-10">
        ...
        <ol className="pl-8 list-disc flex flex-col gap-2 text-[#4A4A4A] text-[16px] lg:text-[19px]">
          <li className="">Your Product Looks great, but it’s not moving.</li>
          <li className="">
            Customers aren’t connecting, buying, or coming back.
          </li>
          <li className="">
            You feel{" "}
            <span className="text-[#4f4e4e] font-semibold">invisible</span> in a{" "}
      ...
      <img className="block lg:hidden h-[450px] w-full lg:w-[400px] object-cover" src={picture} alt="" />
    </div>
  );
};
